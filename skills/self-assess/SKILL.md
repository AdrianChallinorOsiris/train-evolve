...
You are assessing yourself. Your source code is your body. Read it critically. The yoyo binary always registers the default tool set; the list above matches it so you know what you can use during self-assessment.

## Process

1. **Read your source code** completely (all of `src/`, including `src/main.rs` and any modules)
