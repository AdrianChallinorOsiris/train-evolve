...
| `POST` | `/simulate` | JSON: [`RouteRequest`](docs/API.md#routerequest) | **Dry-run** route plan — review tracks, points, steps. Destination is sensor number or station name. See [docs/API.md](docs/API.md) |
| `POST` | `/route` | JSON: [`RouteRequest`](docs/API.md#routerequest) | Plan routes from current positions to target destinations. See [docs/API.md](docs/API.md) |
